module.exports = {
    ...
    adminId: "1220645095389270019", //- Replace UserId with the Discord ID of the admin of the bot
    token: process.env.token || "", //- Bot's Token
    clientId: process.env.clientId || "1248163258775371840", //- ID of the bot
    clientSecret: process.env.clientSecret || "LE4pmWUeWYHJYzvjPwF1xFMUAtg8wHP8", //- Client Secret of the bot
    port: 4200, //- Port of the API and Dashboard
    scopes: ["identify", "guilds", "applications.commands"], //- Discord OAuth2 Scopes
    inviteScopes: ["bot", "applications.commands"], // Invite link scopes
    serverDeafen: true, //- If you want bot to stay deafened
    defaultVolume: 100, //- Sets the default volume of the bot, You can change this number anywhere from 1 to 100
    supportServer: "https://discord.gg/CUtsFUpm", //- Support Server Link
    Issues: "https://aetherscode.xyz", //- Bug Report Link
    ...
    website: "https://aetherscode.xyz", //- without the / at the end
