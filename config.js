    ...
    nodes: [
        {
            ...
            host: "54.36.225.156", //- The host name or IP of the lavalink server.
            port: 2335, // The port that lavalink is listening to. This must be a number!
